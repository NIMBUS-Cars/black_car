...
#include "black_car/CarObject.h"
#include "black_car/CarObjects.h"
...
class LaneFollower{
    ...
    LaneFollower():image_transport(n) {
        ...
        object_detection_pub = n.advertise<black_car::CarObjects>(object_detection_topic,10);
        // Load pytorch model
        try {
  ...
  void image_callback(const sensor_msgs::ImageConstPtr& msg){
      ...
      black_car::CarObjects objectsDetected;
      bool foundCar = false;
      long minX= 256;
      long maxX=0;
      long minY = 256;
    ...
    //TEST DATA
    black_car::CarObject testObject;
    if(foundCar){
